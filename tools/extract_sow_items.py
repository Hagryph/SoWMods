...
def write_catalog_docs(parsed, cats, outdir):
    import os
    ...
    catalog = os.path.join(outdir, 'catalog.md')
...
def main():
    ...
    # ---- sophisticated grouping + sorting, emitted as offline docs only ----
    write_catalog_docs(parsed, cats, outdir)
